    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_date', models.DateField()),
                ('to_date', models.DateField()),
                ('dept_no', models.ForeignKey(db_column='dept_no', on_delete=django.db.models.deletion.DO_NOTHING, to='myems.departments')),
                ('emp_no', models.ForeignKey(db_column='emp_no', on_delete=django.db.models.deletion.DO_NOTHING, to='myems.employee')),
            ],
            options={
